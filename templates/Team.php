...
<link rel="stylesheet" href="/templates/tfiles/font-awesome.css">
<section class="team">
  <div class="container">
    <div class="row">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/s1598_1359675908.jpg" class="img-responsive">
               </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/s1795_1436144975.jpg" class="img-responsive">
               </div>
              <h1> Dr. Muhamad Widus Sempo   </h1>
              <h1>  Tafsir and Malay Manuscript Studies  </h1>
              <p> Islamic Science Institute (ISI) Universiti Sains Islam Malaysia   </p>
            </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/dr_nain_1415608829.jpg" class="img-responsive">
               </div>
              <h1>  Dr. Khairun Nain Nor Aripin  </h1>
              <h1> Systematic reviews and Evidence Based Medicine, Pharmacology</h1>
              <p>  Faculty of Medicine and Health Sciences (FPSK)  </p>
            </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/Norita_Md_Norwawi.png" class="img-responsive" width="130" border="0">
               </div>
              <h1> Prof Dr. Norita Md Norwawi   </h1>
              <h1> Data Mining, Knowledge Engineering, Knowledge Data Discovery   </h1>
              <p>  Faculty of Science and Technology (FST)  </p>
            </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/prof_dr_roshada_1465345101.jpg" class="img-responsive">
               </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/dr_asmaddy_1366510940.jpg" class="img-responsive">
               </div>
              <h1>Dr. Asmaddy Haris</h1>
              <h1>  Development Economics, Social Security  </h1>
              <p>Faculty of Economics &amp; Muamalat (FEM)    </p>
            </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/827_1377675982.jpg" class="img-responsive">
               </div>
              <h1>Dr. Wan Shahida Wan Sulaiman</h1>
              <h1>  Human Gut Microbiology  </h1>
              <p>  Faculty of Medicine and Health Sciences (FPSK)
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/S823.jpg" class="img-responsive" width="100">
               </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/819_1375230053.jpg" class="img-responsive">
               </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/dr_dzul_1415607872_1458619942.jpg" class="img-responsive">
               </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 profile">
              <div class="img-box">
                <img src="/templates/tfiles/873_1375228423.jpg" class="img-responsive">
               </div>
...
</div></div></div></div></div></section></section></body></html>

<hr /><!-- HTML Codes by Quackit.com --></body>
</html>
<title></title>
...
<!-- Col Md 8 --><!-- container fluid ends --><script src="refund%20and%20cancellation_files/bootstrap.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script><script src="refund%20and%20cancellation_files/jquery-3.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script><script type="text/javascript" src="refund%20and%20cancellation_files/tagcanvas.js"></script><script type="text/javascript"> 
$(document).ready(function() {   if( ! $('#myCanvas').tagcanvas({     textColour : '#000000',     outlineThickness : 1,     maxSpeed : 0.03,     depth : 0.75   })) {     // TagCanvas failed to load     
    $('#myCanvasContainer').hide();   }   
    // your other jQuery stuff here...   
    $('#myCanvasContainer').hide(); 
