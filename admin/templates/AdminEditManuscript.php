...
<style type="text/css">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Manuscript</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- Page Header -->
             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped ">
                       ...
                       <?php if(isset($manuscript->id)){  ?>
                       <tr data-id="<?php echo $manuscript->id; ?>">
                            <td class="manuscript_no"><?php echo $manuscript->manuscript_no; ?></td>
                            <td class="bab"><?php echo $manuscript->bab; ?></td>
                            <td class="page"><?php echo $manuscript->page; ?></td>
                            <td class="trans_arabic"><?php echo $manuscript->trans_arabic; ?></td>
                            <td class="trans_english"><?php echo $manuscript->trans_english; ?></td>
                            <td class="trans_malay"><?php echo $manuscript->trans_malay; ?></td>
                      </tr>    
                       <?php } ?>
                    </table>
                    </form>
