...
<style type="text/css">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Quran</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- Page Header -->
             ...
             <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped ">
                       ...
                       <?php if(isset($quran->id)){  ?>
                       <tr data-id="<?php echo $quran->id; ?>">
                            <td class="surah"><?php echo $quran->surah; ?></td>
                            <td class="verse"><?php echo $quran->verse; ?></td>
                            <td class="ayat"><?php echo $quran->ayat; ?></td>
                            <td class="trans_english"><?php echo $quran->trans_english; ?></td>
                            <td class="trans_malay"><?php echo $quran->trans_malay; ?></td>
                      </tr>    
                       <?php } ?>
                    </table>
                    </form>
